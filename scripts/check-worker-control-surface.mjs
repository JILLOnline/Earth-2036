...
const requiredViews = [
  ...
  "data/runtime/workgraph/worker-view/routing/earth-scout.json",
  "data/runtime/workgraph/worker-view/routing/council-alpha.json",
  "data/runtime/workgraph/worker-view/routing/council-beta.json",
  "data/runtime/workgraph/worker-view/routing/deep-resolver.json",
